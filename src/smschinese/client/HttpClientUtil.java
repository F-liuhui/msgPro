...
public class HttpClientUtil {
	...
	//ConnectionRequestTimeout 从连接池获取一个有效连接的超时时间
	//连接配置
	...
	public static CloseableHttpClient getHttpClient() {
        String proxyHost = "proxy1.bj.petrochina";
        int proxyPort = 8080;
	...
	//a設置代理，通过代理发送短信(https)，待完善
	public static CloseableHttpClient getHttpClient(HttpGet httpGet) throws MalformedURLException, IOException {
        String proxyHost = "proxy1.bj.petrochina";
        int proxyPort = 8080;
        //a代理对象
        HttpHost proxy = new HttpHost(proxyHost, proxyPort);  
        ...
        //a创建具有代理功能和https加密功能的httpclient
        CloseableHttpClient httpclient = HttpClients.custom().setRoutePlanner(routePlanner).setSSLHostnameVerifier(hostnameVerifier).build();
       return httpclient;
	}
	/**
	   * 发送 post请求
	...
	/**
	 * @Title: sendMsgUtf8 @Description: TODO(发送utf8) @param: @param
	 * Uid @param: @param Key @param: @param content @param: @param
	 * mobiles @param: @return @date: 2017-3-22 下午5:58:07 @throws
	 */
	 ...
	 * @Title: sendMsgUtf8 @Description: TODO(发送utf8) @param: @param
	 * Uid @param: @param Key @param: @param content @param: @param
	 * mobiles @param: @return @return: int @author: ly @date: 2017-3-22
	 * 下午5:58:07 @throws
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
